...
public class KSMOD_MasterDeckViewScreenPatch
{
    ...
    public static class updatePositions
    {
        public static SpireReturn<Object> Prefix(MasterDeckViewScreen deck) throws NoSuchFieldException, IllegalAccessException
        {
            ...
            {
                Field hoveredCard = KSMOD_ReflectTool.GetFieldByReflect(MasterDeckViewScreen.class, "hoveredCard");
                hoveredCard.set(deck, null);
                for (int i = 0; i < cards.size(); ++i)
                {
                    AbstractCard card = cards.get(i);
                    int mod = i % CARDS_PER_LINE;
                    Float currentDiffY = KSMOD_ReflectTool.GetFieldByReflect(MasterDeckViewScreen.class, "currentDiffY").getFloat(deck);
    ...
    public static class calculateScrollBounds
    {
        public static SpireReturn<Object> Prefix(MasterDeckViewScreen deck) throws NoSuchFieldException, IllegalAccessException
        {
            ...
            if (HasLongCard(cards))
            {
                Field scrollUpperBound = KSMOD_ReflectTool.GetFieldByReflect(MasterDeckViewScreen.class, "scrollUpperBound");
                ...
                Field prevDeckSize = KSMOD_ReflectTool.GetFieldByReflect(MasterDeckViewScreen.class, "prevDeckSize");
