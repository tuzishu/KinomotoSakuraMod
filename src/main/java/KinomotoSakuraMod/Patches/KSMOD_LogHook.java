...
{
//    @SpirePatch(clz = FlashPowerEffect.class, method = SpirePatch.CONSTRUCTOR, paramtypez = {AbstractPower.class})
...
//        {
//            TextureAtlas.AtlasRegion img = (TextureAtlas.AtlasRegion) KSMOD_ReflectTool.GetFieldByReflect(FlashPowerEffect.class, "region128").get(effect);
//            KSMOD_LoggerTool.Logger.info(power.ID);
//            KSMOD_LoggerTool.Logger.info(power.region128);
//        }
//    }
//
