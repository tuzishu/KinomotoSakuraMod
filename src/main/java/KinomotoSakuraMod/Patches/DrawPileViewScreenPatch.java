...
public class DrawPileViewScreenPatch
{
    ...
    public static class updatePositions
    {
        public static SpireReturn<Object> Prefix(DrawPileViewScreen deck) throws NoSuchFieldException, IllegalAccessException
        {
            ...
            {
                Field hoveredCard = Utility.GetFieldByReflect(DrawPileViewScreen.class, "hoveredCard");
                hoveredCard.set(deck, null);
                for (int i = 0; i < cards.size(); ++i)
                {
                    AbstractCard card = cards.get(i);
                    int mod = i % CARDS_PER_LINE;
                    Float currentDiffY = Utility.GetFieldByReflect(DrawPileViewScreen.class, "currentDiffY").getFloat(deck);
    ...
    public static class calculateScrollBounds
    {
        public static SpireReturn<Object> Prefix(DrawPileViewScreen deck) throws NoSuchFieldException, IllegalAccessException
        {
            ...
            if (HasLongCard(cards))
            {
                Field scrollUpperBound = Utility.GetFieldByReflect(DrawPileViewScreen.class, "scrollUpperBound");
                ...
                Field prevDeckSize = Utility.GetFieldByReflect(DrawPileViewScreen.class, "prevDeckSize");
