...
public class MasterDeckViewScreenPatch
{
    ...
    public static class updatePositions
    {
        public static SpireReturn<Object> Prefix(MasterDeckViewScreen deck) throws NoSuchFieldException, IllegalAccessException
        {
            ...
            {
                Field hoveredCard = Utility.GetFieldByReflect(MasterDeckViewScreen.class, "hoveredCard");
                hoveredCard.set(deck, null);
                for (int i = 0; i < cards.size(); ++i)
                {
                    AbstractCard card = cards.get(i);
                    int mod = i % CARDS_PER_LINE;
                    Float currentDiffY = Utility.GetFieldByReflect(MasterDeckViewScreen.class, "currentDiffY").getFloat(deck);
    ...
    public static class calculateScrollBounds
    {
        public static SpireReturn<Object> Prefix(MasterDeckViewScreen deck) throws NoSuchFieldException, IllegalAccessException
        {
            ...
            if (HasLongCard(cards))
            {
                Field scrollUpperBound = Utility.GetFieldByReflect(MasterDeckViewScreen.class, "scrollUpperBound");
                ...
                Field prevDeckSize = Utility.GetFieldByReflect(MasterDeckViewScreen.class, "prevDeckSize");
