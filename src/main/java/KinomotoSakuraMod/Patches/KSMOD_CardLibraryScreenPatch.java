...
public class KSMOD_CardLibraryScreenPatch
{
    ...
    private static float PAD_X = KSMOD_AbstractMagicCard.IMG_WIDTH * 0.778F * Settings.scale + Settings.CARD_VIEW_PAD_X;
    private static float PAD_Y = KSMOD_AbstractMagicCard.IMG_HEIGHT * 0.79F * Settings.scale + Settings.CARD_VIEW_PAD_Y;
