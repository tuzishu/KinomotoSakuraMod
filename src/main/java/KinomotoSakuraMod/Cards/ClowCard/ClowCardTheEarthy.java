...
public class ClowCardTheEarthy extends KSMOD_AbstractMagicCard
{
    ...
    private static final int BASE_MAIGC_NUMBER = 3;
    ...
    {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(player, player, new KSMOD_EarthyPower(player, this.magicNumber), this.magicNumber));
