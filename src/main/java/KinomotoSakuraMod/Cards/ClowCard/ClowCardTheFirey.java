...
import KinomotoSakuraMod.Cards.SakuraCard.SakuraCardTheFirey;
...
public class ClowCardTheFirey extends KSMOD_AbstractMagicCard
{
    ...
    public ClowCardTheFirey()
    {
        ...
        this.cardsToPreview = new SakuraCardTheFirey();
    ...
    public void applyNormalEffect(AbstractPlayer player, AbstractMonster monster)
    {
        ...
        AbstractDungeon.actionManager.addToBottom(new MakeTempCardInHandAction(new SpellCardHuoShen(), this.magicNumber));
    }
}
