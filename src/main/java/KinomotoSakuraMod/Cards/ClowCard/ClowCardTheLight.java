...
public class ClowCardTheLight extends AbstractMagicCard
{
    ...
    public void use(AbstractPlayer player, AbstractMonster monster)
    {
        ...
        {
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(mon, player, new LightElementPower(mon, this.correctMagicNumber()), this.correctMagicNumber()));
        }
    }
}
