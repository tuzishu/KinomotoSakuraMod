...
public class SakuraCardTheBig extends KSMOD_AbstractMagicCard
{
    public static final String ID = "SakuraCardTheBig";
    private static final String NAME;
    private static final String DESCRIPTION;
    private static final String IMAGE_PATH = "img/cards/sakuracard/the_big.png";
    ...
    {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(player, player, new KSMOD_BigPower_SakuraCard(player, 1)));
    }
}
