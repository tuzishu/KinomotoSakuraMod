...
import KinomotoSakuraMod.Cards.ClowCard.ClowCardTheWatery;
import KinomotoSakuraMod.Cards.KSMOD_AbstractMagicCard;
import KinomotoSakuraMod.Patches.KSMOD_CustomCardColor;
import KinomotoSakuraMod.Patches.KSMOD_CustomTag;
import KinomotoSakuraMod.Powers.KSMOD_WateryPower_SakuraCard;
...
public class SakuraCardTheWatery extends KSMOD_AbstractMagicCard
{
    public static final String ID = "SakuraCardTheWatery";
    private static final String NAME;
    private static final String DESCRIPTION;
    private static final String IMAGE_PATH = "img/cards/sakuracard/the_watery.png";
    ...
    public KSMOD_AbstractMagicCard makeCopy()
    {
        ...
        return new SakuraCardTheWatery();
    }
