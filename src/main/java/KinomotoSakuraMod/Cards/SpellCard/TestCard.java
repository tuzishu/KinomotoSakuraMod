...
public class TestCard extends KSMOD_AbstractSpellCard
{
    ...
    {
        AbstractDungeon.actionManager.addToBottom(new DamageAllEnemiesAction(player, KSMOD_DataTool.GetDamageList(this.damage), this.damageType, AbstractGameAction.AttackEffect.SLASH_HORIZONTAL));
    }
}
