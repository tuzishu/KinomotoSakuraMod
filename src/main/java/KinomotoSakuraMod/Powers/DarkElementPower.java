...
public class DarkElementPower extends CustomPower
{
    public static final String POWER_ID = "DarkElementPower";
    private static final String POWER_NAME;
    private static final String[] POWER_DESCRIPTIONS;
    private static final String POWER_IMG_PATH = "img/powers/default_power.png";
    private static final PowerType POWER_TYPE = PowerType.DEBUFF;
    private static final int WEAKENED_AMOUNT = 1;
    ...
    public DarkElementPower(AbstractCreature target, int amount)
    {
    ...
    public static boolean TryActiveEarthyElement(AbstractMonster target, int needAmount, boolean isExhaust)
    {
        ...
        {
            power = target.getPower(DarkElementPower.POWER_ID);
        }
        else
        {
            return false;
        ...
        if (power.amount >= needAmount)
        {
            ...
            AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(player, player, new WeakPower(target, WEAKENED_AMOUNT, false), WEAKENED_AMOUNT));
            if (isExhaust)
            {
