...
public class KSMOD_CloudPower extends KSMOD_CustomPower
{
    public static final String POWER_ID = "KSMOD_CloudPower";
    ...
    public KSMOD_CloudPower(AbstractCreature target, int amount)
    {
