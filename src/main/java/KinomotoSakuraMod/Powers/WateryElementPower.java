...
public class WateryElementPower extends CustomPower
{
    public static final String POWER_ID = "WateryElementPower";
    ...
    public WateryElementPower(AbstractCreature target, int amount)
    {
    ...
    {
        AbstractPower power;
        if (target.hasPower(WateryElementPower.POWER_ID))
        {
            power = target.getPower(WateryElementPower.POWER_ID);
        }
        else
        {
            return false;
