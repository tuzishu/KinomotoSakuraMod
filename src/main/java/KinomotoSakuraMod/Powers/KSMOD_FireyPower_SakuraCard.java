...
public class KSMOD_FireyPower_SakuraCard extends KSMOD_CustomPower
{
    ...
    private static final String POWER_IMG_PATH = "img/powers/firey_power_sakuracard.png";
    ...
    {
        AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(this.owner, this.owner, new KSMOD_FireyPower(this.owner, 1)));
    }
}