...
public class KSMOD_CloudPower_SakuraCard extends KSMOD_CustomPower
{
    public static final String POWER_ID = "KSMOD_CloudPower_SakuraCard";
    ...
    public KSMOD_CloudPower_SakuraCard(AbstractCreature target, int amount)
    {
