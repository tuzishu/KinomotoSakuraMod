...
public class KSMOD_WindyPower_SakuraCard extends KSMOD_CustomPower
{
    ...
    private static final String POWER_IMG_PATH = "img/powers/windy_power_sakuracard.png";
    ...
    {
        AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(this.owner, this.owner, new KSMOD_WindyPower(this.owner, 1)));
    }
}
