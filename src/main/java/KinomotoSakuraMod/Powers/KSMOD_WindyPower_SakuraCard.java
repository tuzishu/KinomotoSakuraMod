...
public class KSMOD_WindyPower_SakuraCard extends KSMOD_CustomPower
{
    ...
    {
        if (!this.owner.hasPower(KSMOD_WindyPower.POWER_ID))
        {
            AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(this.owner, this.owner, new KSMOD_WindyPower(this.owner, 1), 1));
        }
    }
}
