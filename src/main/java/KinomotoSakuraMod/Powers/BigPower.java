...
public class BigPower extends CustomPower
{
    public static final String POWER_ID = "BigPower";
    ...
    public BigPower(int amount)
    {
        this(AbstractDungeon.player, amount);
    }

    public BigPower(AbstractCreature target, int amount)
    {
