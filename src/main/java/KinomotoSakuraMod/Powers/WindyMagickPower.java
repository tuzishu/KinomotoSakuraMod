...
public class WindyMagickPower extends CustomPower
{
    public static final String POWER_ID = "WindyMagickPower";
    ...
    public WindyMagickPower(AbstractCreature target, int amount)
    {
